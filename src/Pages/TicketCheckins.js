...
const EachData = ({element,clickOnCheckIn}) => {
  ...
  return (
    ...
    <img 
    className={Style.img}
    src={element.user.pic}
    />  
    
    <div className={Style.info}>
<p className={Style.member_name}>{`${element.user.first_name}${element.user.last_name}`}</p>
   ...
   <p className={Style.price}>
    ...
    <button className={element.isCheckedIn || state? Style.greenbutton :Style.button} onClick={async () => {
